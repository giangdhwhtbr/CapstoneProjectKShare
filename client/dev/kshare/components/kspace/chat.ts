...
import { ChatRoom } from '../../../dashboard/interface/chatRoom';
import { Message } from '../../../dashboard/interface/message';
...
@Component({
    selector: 'chat',
    templateUrl: 'client/dev/kshare/templates/kspace/chat.html',
    styleUrls: ['client/dev/kshare/styles/chat.css'],
