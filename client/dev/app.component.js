 ...
 * Components
 */
var user_list_1 = require('../dev/dashboard/components/users/user-list');
var user_info_1 = require('../dev/dashboard/components/users/user-info');
...
var AppComponent = (function () {
    ...
    AppComponent = __decorate([
        ...
        router_1.RouteConfig([
            { path: '/admin/users', name: 'User Management', component: user_list_1.UserListComponent },
            { path: '/admin/users:id', name: 'User Management', component: user_info_1.UserInfoComponent },
